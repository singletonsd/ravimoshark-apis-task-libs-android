...
public class InlineResponse200 implements Serializable{
  ...
  private List<Interventions> items = null;
  ...
  **/
  ...
  public InlineResponse200 items(List<Interventions> items) {
    this.items = items;
    return this;
  }

  public InlineResponse200 addItemsItem(Interventions itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Interventions>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Interventions> getItems() {
    return items;
  }

  public void setItems(List<Interventions> items) {
    this.items = items;
  }
