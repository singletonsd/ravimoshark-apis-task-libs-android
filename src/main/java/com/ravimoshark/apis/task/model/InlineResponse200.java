...
public class InlineResponse200 implements Serializable{
  ...
  **/
  ...
  public InlineResponse200 items(List<Clients> items) {
    this.items = items;
    return this;
  }

  public InlineResponse200 addItemsItem(Clients itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Clients>();
    }
  ...
  **/
  ...
  public void setItems(List<Clients> items) {
    this.items = items;
  }
