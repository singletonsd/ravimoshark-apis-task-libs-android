...
public class InlineResponse2005 implements Serializable{
  ...
  private List<Pieces> items = null;

  public InlineResponse2005 metadata(Metadata metadata) {
  ...
  **/
  ...
  public InlineResponse2005 items(List<Pieces> items) {
    this.items = items;
    return this;
  }

  public InlineResponse2005 addItemsItem(Pieces itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Pieces>();
    }
  ...
  **/
  ...
  public void setItems(List<Pieces> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.metadata, inlineResponse2005.metadata) &&
        Objects.equals(this.items, inlineResponse2005.items);
  }
