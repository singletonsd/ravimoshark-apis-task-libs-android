 ...
 */
@JsonAdapter(Reviewed.Adapter.class)
public enum Reviewed {
  ...
  public static Reviewed fromValue(String text) {
    for (Reviewed b : Reviewed.values()) {
  ...
  public static class Adapter extends TypeAdapter<Reviewed> {
    @Override
    public void write(final JsonWriter jsonWriter, final Reviewed enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Reviewed read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Reviewed.fromValue(String.valueOf(value));
    }
  }
}
